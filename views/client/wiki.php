    ...
    <div class="md:flex    p-10 ">
        ...
        <div class=" basis-1 md:basis-1/4 p-6 bg-slate-800 text-slate-50 mt-10  mx-6 max-h-min">
            ...
            <?php if (isset($_SESSION['id']) && $_SESSION['id'] == $wiki->writer) { ?>
                <a href="edit-wiki?id=<?= $wiki->id ?>" type="button" class=" text-center mt-8 focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 w-full">Edit</a> <br>
